...
COMBINED_STRUCTURE = (
    ...
    "by eye.\n"
    "REVENUE RULE: when the DATA reports conversion value / revenue / ROAS, this is an E-COMMERCE "
    "client and REVENUE is the headline measure on every performance slide — conversion COUNT is "
    "secondary. A period with fewer conversions but higher revenue is a GOOD period (fewer, larger "
    "orders): report it as a win, led by the revenue figure, and never place that conversion drop "
    "on the Needs Attention slide. Judge paid spend on ROAS, not on cost per conversion.\n\n"
