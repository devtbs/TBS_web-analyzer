...
GSC_STRUCTURE = (
    ...
    "REQUIRED — label the THREE highest-impression bubbles directly. Do this with a SECOND scatter trace (not annotations): a trace "
    "containing ONLY those 3 points, \"mode\":\"markers+text\", \"text\":[the 3 query strings], \"textposition\":\"top center\", "
    "\"textfont\":{\"color\":\"<--ink>\",\"size\":12}, same marker sizing/colour as the main trace, \"showlegend\":false, so the three "
    "labels are baked into the chart data and always render. Leave all other bubbles unlabeled.\n"
