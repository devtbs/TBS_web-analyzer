...
async def generate_library_proposal(analysis: Dict, entry: Dict, *, provider: str = None,
    ...
    built here is the page around it: the reference summary sections, re-worded by the model for
    this client from their own analysis, with the chosen deck embedded underneath. Picking a
