                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-12">
                            ...
                            <div className="mt-16 pt-12 border-t-2 border-slate-100">
                                <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-8">
                                    <div>
                                        <h2 className="text-2xl font-black text-slate-900 mb-2">Generate Full Article</h2>
                                        <p className="text-slate-500 font-medium">
                                            Ready to write? Transform this brief into a comprehensive, highly-engaging article with one click.
                                        </p>
                                    </div>
                                    <button
                                        onClick={async () => {
                                            ...
                                            try {
                                                ...
                                                setDocumentData({ ...documentData, content_type: "Full Article", content: { ...briefData, article_markdown: res.data.article } });
                                        ...
                                        disabled={loading}
                                        className="flex items-center gap-2 bg-blue-600 outline-none hover:bg-blue-700 text-white px-6 py-3 rounded-xl font-bold transition-all disabled:opacity-50 flex-shrink-0"
                                    >
